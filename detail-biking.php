...
<body>
    <div class="layout">
      ...
      <div class="two-column-Info">
        ...
        <div class="info-box">
          <p>President Teddy Roosevelt named Devil's Tower the first national monument in 1906. Today, the park hosts approximately 450,000 visitors annually; 5,000 of those visitors are climbers. But beware, environmentalists are trying to limit that number so treat the park with respect.</p>
        </div>
      </div>
